...
import com.sampleapp.model.Mail;
...
public class MailService {
    ...
    public void sendEmailVerification(String emailVerificationUrl, String to)
        ...
        Mail mail = new Mail();
        mail.setSubject("Email Verification [Sooper Exchange]");
        mail.setTo(to);
     ...
     */
    public void sendResetLink(String resetPasswordLink, String to, String token)
            throws IOException, TemplateException, MessagingException {
        ...
        Mail mail = new Mail();
        mail.setSubject("Password Reset Link [Sooper Exchange]");
        mail.setTo(to);
        mail.setFrom(mailFrom);
        mail.getModel().put("userName", to);
        mail.getModel().put("userResetPasswordLink", resetPasswordLink);
        mail.getModel().put("resetToken", token);
    ...
    public void sendAccountChangeEmail(String action, String actionStatus, String to)
            throws IOException, TemplateException, MessagingException {
        Mail mail = new Mail();
        mail.setSubject("Account Status Change [Sooper Exchange]");
        mail.setTo(to);
        mail.setFrom(mailFrom);
        mail.getModel().put("userName", to);
